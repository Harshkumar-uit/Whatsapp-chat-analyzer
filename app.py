...
st.sidebar.title("whatsapp chat analyer")

uploaded_file = st.sidebar.file_uploader("Choose a file")
if uploaded_file is not None:
    # To read file as bytes:
    bytes_data = uploaded_file.getvalue()
    ''' we will upload the file it will be a stream of a byte data so we are going to convert it into string'''
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        col1,col2,col3,col4  = st.columns(4) #here we have used columns instead of betcolumns
